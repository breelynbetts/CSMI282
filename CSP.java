...
public class CSP {
    ...
    private static boolean checkDates (String operand, LocalDate day1, LocalDate day2 ) {
    	switch(operand) {
    		case "==": 
    			if (day1.isEqual(day2)) return true;
    			break;
    		case "!=":
    			if (!day1.isEqual(day2)) return true;
    			break;
    		case ">":  
    			if (day1.isAfter(day2)) return true;
    			break;
    		case "<":  
    			if (day1.isBefore(day2)) return true;
    			break;
    		case ">=": 
    			if (day1.isAfter(day2) || day1.isEqual(day2)) return true;
    			break;
    		case "<=": 
    			if (day1.isBefore(day2) || day1.isEqual(day2)) return true;
    			break;
    	}
    	return false;
    }
    
    private static boolean checkBinaryConstraint (BinaryDateConstraint constraint, LocalDate date, PartialState party, List<LocalDate> assignment ) {
